...
public class controller {
	...
	/*
	 * 1. Add proper annotaions to have a check if the ticket body is valid
	 * as per the restrictions  specified.
	 * 2. Add BindingResult parameter to throw error if the body 
	 * is not valid.
	 */
	@PostMapping("/ticket")
